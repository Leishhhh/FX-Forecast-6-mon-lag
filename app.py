...
url = "https://raw.githubusercontent.com/Leishhhh/FX-Forecast-6-mon-lag/main/One%20Year%20Lag%20Model%20FX%20Rates%20Data.csv"
...
if lag_date in df['Date'].values:
    lagged_row = df.loc[df['Date'] == lag_date, ['CPI_lag1','Nifty_lagged','Gold_lagged',"Forward_lagged"]].copy()
